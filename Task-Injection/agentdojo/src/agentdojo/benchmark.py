...
def run_task_with_injection_tasks(
    ...
    for injection_task_id in injection_tasks_to_run:
        ...
        task_injections = attack.attack(user_task, injection_task) # return a dictionary containing the injection placeholders that are seen by the agent when execuring the task correctly, and the corresponsing injections
