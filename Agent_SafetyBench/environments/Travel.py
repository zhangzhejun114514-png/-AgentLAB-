...
class Travel(BaseEnv):
    ...
    def get_contact_information_for_restaurants(self, restaurant_name):
        ...
        try:
            ...
            return {"success": False, "data": "Invalid restaurant information."}
    ...
    def get_price_for_restaurants(self, restaurant_name):
        ...
        try:
            ...
            return {"success": False, "address": f"Invalid restaurant name {restaurant_name}"}
    ...
    def get_car_price_per_day(self, company_name):
        ...
        try:
            ...
            return {"success": False, "company_info": "Invalid company name."}
